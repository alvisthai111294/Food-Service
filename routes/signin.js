...
/**
 * @api {delete} /auth Request to sign out in the system
 * @apiName DeleteAuth
 * @apiGroup Auth
 * 
 * @apiSuccess {boolean} success true when successfully sign out and delete cookies
 * @apiSuccess {String} deleted "true"
 * 
 */ 
