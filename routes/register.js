 ...
 * @apiParam {String} confirmpassword confirmation of password
...
router.post('/', (request, response) => {
    ...
    if (isProvided(first) && isProvided(last) && isProvided(username) && isProvided(email)
             && isProvided(password) && isProvided(confirmpassword)) {
        if (!email.includes('@') || !email.includes('.') || password !== confirmpassword) {
