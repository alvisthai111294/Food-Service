...
app.use('/orders', middleware.checkTokenCookies, require('./routes/orders.js'))
app.use('/ordersguest', require('./routes/ordersguest.js'))
app.use('/carts', middleware.checkTokenCookies, require('./routes/carts.js'))
app.use('/member', middleware.checkTokenCookies, require('./routes/member.js'))
